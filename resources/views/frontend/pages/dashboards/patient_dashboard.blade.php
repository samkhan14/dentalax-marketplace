        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card border-0 shadow-sm sticky-lg-top" style="top: 100px; z-index: 1000;">
                        <div class="list-group list-group-flush">
                            ...
                            <a href="{{ route('patient.dashboard', ['page' => 'profile']) }}"
                                class="list-group-item list-group-item-action fw-medium {{ $page === 'profile' ? 'active' : '' }}">
                                <i class="fas fa-user me-2"></i> Mein Profil
                            </a>

                            <a href="{{ route('patient.dashboard', ['page' => 'reviews']) }}"
                                class="list-group-item list-group-item-action fw-medium {{ $page === 'reviews' ? 'active' : '' }}">
                                <i class="fas fa-star me-2"></i> Bewertungen
                            </a>

                            <a href="{{ route('patient.dashboard', ['page' => 'security']) }}"
                                class="list-group-item list-group-item-action fw-medium {{ $page === 'security' ? 'active' : '' }}">
                ...
                <div class="col-lg-9">
                    ...
                    {{-- <div class="col-lg-9">
                        @if ($page === 'profile')
                            @include('patient.pages.profile')
                        @elseif ($page === 'reviews')
                            @include('patient.pages.reviews')
                        @elseif ($page === 'security')
                            @include('patient.pages.security')
                        @else
                            @include('patient.pages.home')
                        @endif
                    </div> --}}
