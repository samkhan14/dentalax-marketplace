      ...
      <div class="container-fluid px-4">
          ...
          <div class="row align-items-center mb-4">
              <div class="col-md-6">
                  ...
                  <p class="text-muted">Willkommen zurück, {{ Auth::user()->name}}</p>
              </div>
              <div class="col-md-6 text-md-end">
                  <span class="badge bg-success me-2">Premium-Paket: {{ $plan->name }}</span>
                  ...
                  <div class="card border-0 shadow-sm sticky-lg-top" style="top: 100px; z-index: 1000;">
                      <div class="list-group list-group-flush">
                          <a href="{{route('dentist.dashboard')}}"
                              class="list-group-item list-group-item-action fw-medium {{ !$page ? 'active' : '' }}">
                              <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                          </a>
                          <a href="{{route('dentist.dashboard', ['page' => 'landingpage'])}}"
                              class="list-group-item list-group-item-action fw-medium {{ $page == 'landingpage' ? 'active' : '' }}">
                              <i class="fas fa-globe me-2"></i> Landingpage
                          </a>
                          <a href="{{route('dentist.dashboard', ['page' => 'praxisdaten'])}}"
                              class="list-group-item list-group-item-action fw-medium {{ $page == 'praxisdaten' ? 'active' : '' }}">
                              <i class="fas fa-clinic-medical me-2"></i> Praxisdaten
                          </a>
                          <a href="{{route('dentist.dashboard', ['page' => 'termine'])}}"
                              class="list-group-item list-group-item-action fw-medium {{ $page == 'termine' ? 'active' : '' }}">
                              <i class="fas fa-calendar-alt me-2"></i> Terminverwaltung
                          </a>
                          <a href="{{route('dentist.dashboard', ['page' => 'bewertungen'])}}"
                              class="list-group-item list-group-item-action fw-medium {{ $page == 'bewertungen' ? 'active' : '' }}">
                              <i class="fas fa-star me-2"></i> Bewertungen
                          </a>
                          <a href="{{route('dentist.dashboard', ['page' => 'abo'])}}"
                              class="list-group-item list-group-item-action fw-medium {{ $page == 'abo' ? 'active' : '' }}">
                              <i class="fas fa-tags me-2"></i> Abo & Pakete
                          </a>
                          <a href="{{route('dentist.dashboard', ['page' => 'stellenangebote'])}}"
                              class="list-group-item list-group-item-action fw-medium {{ $page == 'stellenangebote' ? 'active' : '' }}">
                  ...
                  <div class="card border-0 shadow-sm mt-3">
                      <div class="card-body p-3">
                          <div class="d-flex align-items-center">
                              ...
                              <div>
                                  <h6 class="mb-0">Dr. {{ Auth::user()->name }}</h6>
