      ...
      <div class="row min-vh-75 align-items-center py-5">
        ...
        <div class="col-lg-7 mb-5 mb-lg-0 text-center text-lg-start">
          <div class="text-white mb-4 animate__animated animate__fadeInUp">
            ...
            <p class="mb-4">Zahnarztpraxis in Berlin mit modernem Konzept und patientenorientierter Behandlung.</p>
            ...
            <div class="card-body p-4 p-xl-5">
              <div class="d-flex align-items-center mb-4">
                <div class="praxis-logo me-3">
                  <img src="{{ asset('frontend/assets/images/Demo Mitarbeiter E.jpeg')}}" alt="Dentist Logo" class="rounded-circle shadow-sm" style="width: 90px; height: 90px; object-fit: cover; border: 3px solid #fff;">
                </div>
                <div>
              ...
              <div class="card bg-light border-0 mb-4">
                <div class="card-body p-4">
                  <div class="d-flex align-items-center mb-3">
                    <div class="rounded-circle me-3 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; background-color: rgba(63, 191, 216, 0.1);">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <div><a href="mailto:info@zahnarzt-mueller.de" class="text-body fw-medium">info@zahnarzt-mueller.de</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card shadow-sm h-100">
            <div class="card-body">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-8">
                  <p>Willkommen in unserer modernen Zahnarztpraxis im Herzen Berlins. Unser erfahrenes Team bietet Ihnen das gesamte Spektrum aktueller Zahnmedizin auf höchstem Niveau. Wir legen großen Wert auf eine entspannte Atmosphäre und sanfte Behandlungsmethoden, damit Sie sich bei uns rundum wohlfühlen können.</p>

                  <div class="mt-3">
                    <p class="fw-medium mb-2">Unsere Schwerpunkte:</p>
                    <div class="d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-dark p-2">Willkommen in unserer modernen Zahnarztpraxis im Herzen Berlins</span>
                        <span class="badge bg-light text-dark p-2">Willkommen in unserer modernen Zahnarztpraxis im Herzen Berlins</span>
                        <span class="badge bg-light text-dark p-2">Willkommen in unserer modernen Zahnarztpraxis im Herzen Berlins</span>
                        <span class="badge bg-light text-dark p-2">Willkommen in unserer modernen Zahnarztpraxis im Herzen Berlins</span>
                    </div>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-lg-8 text-center">
          ...
          <p class="lead text-muted">Wir bieten das gesamte Spektrum moderner Zahnmedizin, um Ihre Zahngesundheit zu erhalten und Ihr Lächeln zu verschönern.</p>
        </div>
      </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden transform-on-hover">
              <div class="card-body p-4 position-relative z-index-1">
                ...
                <p class="mb-0 text-secondary">Professionelle Zahnreinigung und individuelle Beratung zur optimalen Mundhygiene</p>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 hover-lift overflow-hidden">
              ...
              <div class="card-footer bg-white border-0 p-4 pt-0">
                <button class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#teamModal1">
                ...
                <div class="modal-body">
                  <div class="row g-4">
                    ...
                    <div class="col-md-8">
                      ...
                      <p>Seit über 20 Jahren widmet sich Dr. Müller der Zahnmedizin mit Schwerpunkt auf Implantologie und ästhetischer Zahnheilkunde.</p>

                      <h6 class="section-title mt-4 mb-3">Ausbildung</h6>
                      <ul class="list-unstyled">
                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Studium der Zahnmedizin an der Universität Heidelberg</li>
                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Promotion zum Dr. med. dent.</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i> Weiterbildung in Implantologie</li>
                      </ul>
                      ...
                      <div class="d-flex flex-wrap gap-2">
                        ...
                        <span class="badge bg-light text-dark px-3 py-2">Spanisch (Grundkenntnisse)</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-8 text-center">
          <div class="card bg-light border-0 p-4">
            <div class="card-body">
              ...
              <p class="mb-4">Ihre Meinung ist uns wichtig! Helfen Sie uns, unsere Behandlungsqualität zu verbessern.</p>
                ...
                <div class="card-body p-0">
                  ...
                  <div class="p-4 border-bottom">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <div class="dropdown">
                        <button class="btn btn-outline-primary dropdown-toggle" type="button" id="monatDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                          <i class="far fa-calendar-alt me-2"></i> <span id="current-month-display">April 2025</span>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="monatDropdown">
                          <li><h6 class="dropdown-header">2025</h6></li>
                          <li><a class="dropdown-item month-option" href="#" data-month="3" data-year="2025">März 2025</a></li>
                          <li><a class="dropdown-item month-option active" href="#" data-month="4" data-year="2025">April 2025</a></li>
                          <li><a class="dropdown-item month-option" href="#" data-month="5" data-year="2025">Mai 2025</a></li>
                          <li><a class="dropdown-item month-option" href="#" data-month="6" data-year="2025">Juni 2025</a></li>
                          <li><a class="dropdown-item month-option" href="#" data-month="7" data-year="2025">Juli 2025</a></li>
                          <li><a class="dropdown-item month-option" href="#" data-month="8" data-year="2025">August 2025</a></li>
                          <li><a class="dropdown-item month-option" href="#" data-month="9" data-year="2025">September 2025</a></li>
                        </ul>
                      </div>
                      <div>
                    ...
                    <div class="text-center calendar-grid-container">
                      ...
                      <!-- April 2025 - Woche 1 -->
                      <div class="row g-2 mb-2">
                        <div class="col"><div class="calendar-day inactive">31</div></div>
                        <div class="col"><div class="calendar-day clickable">1<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">2<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">3<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">4<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">5<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day inactive">6</div></div>
                      </div>

                      <!-- April 2025 - Woche 2 -->
                      <div class="row g-2 mb-2">
                        <div class="col"><div class="calendar-day clickable">7<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">8<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">9<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable active">10<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">11<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">12<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day inactive">13</div></div>
                      </div>

                      <!-- April 2025 - Woche 3 -->
                      <div class="row g-2 mb-2">
                        <div class="col"><div class="calendar-day clickable">14<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">15</div></div>
                        <div class="col"><div class="calendar-day clickable">16<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">17<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">18<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">19</div></div>
                        <div class="col"><div class="calendar-day inactive">20</div></div>
                      </div>

                      <!-- April 2025 - Woche 4 -->
                      <div class="row g-2 mb-2">
                        <div class="col"><div class="calendar-day clickable">21</div></div>
                        <div class="col"><div class="calendar-day clickable">22<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">23<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">24<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">25<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">26</div></div>
                        <div class="col"><div class="calendar-day inactive">27</div></div>
                      </div>

                      <!-- April 2025 - Woche 5 -->
                      <div class="row g-2">
                        <div class="col"><div class="calendar-day clickable">28<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">29<span class="availability-dot availability-medium"></span></div></div>
                        <div class="col"><div class="calendar-day clickable">30<span class="availability-dot availability-high"></span></div></div>
                        <div class="col"><div class="calendar-day inactive">1</div></div>
                        <div class="col"><div class="calendar-day inactive">2</div></div>
                        <div class="col"><div class="calendar-day inactive">3</div></div>
                        <div class="col"><div class="calendar-day inactive">4</div></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="p-4 border-bottom">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div>
                        <div class="badge bg-primary py-2 px-3 mb-2 verfuegbare-zeiten-titel">Donnerstag, 10. April</div>
                  ...
                  document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (buchungsModalElement) {
                      buchungsModalElement.addEventListener('show.bs.modal', function(event) {
                        ...
                        const formattedDate = `${selectedWeekday}, ${selectedDay}. ${monthNames[currentMonth-1]}`;
                    ...
                    function updateDateDisplay() {
                      if (selectedDateDisplay) {
                        selectedDateDisplay.innerText = `${selectedWeekday}, ${selectedDay}. ${monthNames[currentMonth-1]} ${currentYear}`;
                        ...
                        if (zeitenTitelElement) {
                          zeitenTitelElement.innerText = `${selectedWeekday}, ${selectedDay}. ${monthNames[currentMonth-1]}`;
                        }
                      }
                    }
                      ...
                      for (let week = 0; week < weeksInMonth; week++) {
                        ...
                        for (let day = 0; day < 7; day++) {
                          if (week === 0 && day < firstDayIndex) {
                            ...
                            html += `<div class="col"><div class="calendar-day inactive">${nextMonthDay}</div></div>`;
                            nextMonthDay++;
                          } else {
                            ...
                            const isActive = (dayCount === selectedDay && currentMonth === month && currentYear === year);
                            ...
                            html += `<div class="col"><div class="calendar-day ${dayClass}${activeClass}" id="day-${year}-${month}-${dayCount}">${dayCount}</div></div>`;
                            dayCount++;
                          }
                        }
