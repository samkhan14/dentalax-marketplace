...
<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="{{ route('admin.dashboard') }}">
        <img class="navbar-brand-dark" src="{{ asset('backend/assets/img/brand/light.svg') }}"
            alt="Zahnärzte Logo admin panel" /> <img class="navbar-brand-light"
            src="{{ asset('backend/assets/img/brand/dark.svg') }}" alt="Zahnärzte Logo admin panel" />
    </a>
    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item {{ $page == 'patients' ? 'active' : '' }}">
                <a href="{{ route('admin.dentists') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
