...
<head>
    ...
    <!-- Sweet Alert -->
    <link type="text/css" href="{{ asset('backend/assets/vendor/sweetalert2/dist/sweetalert2.min.css') }}"
        rel="stylesheet">
    <!-- Notyf -->
    ...
    <link type="text/css" href="{{ asset('backend/assets/css/custom.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('backend/assets/vendor/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}">
    </script>
    <!-- Datepicker -->
